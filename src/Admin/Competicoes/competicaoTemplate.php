...
?>
    ...
    <main class="container">
        <h4 class="mb-3 mt-3" id="competitions">Competições</h4>
        ...
        <?php if (!empty($competicoes)): ?>
            <table
                id="tabela-competicoes"
                class="table"
                aria-describedby="competitions"
                aria-description="Tabela contendo dados de todas as competições cadastradas"
            >
                <thead>
                <tr>
                    <th>ID</th>
...
?>
    ...
    <script>
        ...
        async function criarCompeticao(nome, prazo) {
            ...
            const response = await fetch('/competicoes/acao.php', {
                method: 'POST',
