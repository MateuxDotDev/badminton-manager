...
<head>
  ...
  <?
    htmlLoadStyle("$root/css/style.css");
    htmlLoadStyle("$root/css/swal_toast.css");
  ?>
</head>
<body>
<?
...
<?
htmlLoadScript("$root/js/swal_toast.js");
htmlLoadScript("$root/js/alertas.js");
htmlLoadScript("$root/js/init_tooltips.js");
}
