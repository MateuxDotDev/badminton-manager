...
//            ->setSenhaCriptografada(SenhaCriptografada::criptografar($tecnico1->email(), 'senha1'))
...
//            ->setSenhaCriptografada(SenhaCriptografada::criptografar($tecnico2->email(), 'senha2'))
...
//            ->setId(1)
//            ->setNome('Clube A');
//        $senha = SenhaCriptografada::criptografar('john@example.com', 'senha123');
//
//        $tecnico = (new Tecnico)
